...
<div
   className="relative px-4 bg-cover flex flex-col bg-[url('/HeroForServiceForSm.png')] lg:bg-[url('/AccreditationHero.png')]"
>
  {/* Gradient Overlay */}
  ...
  <div className="mt-[640px] mb-4 z-10 lg:px-14 lg:mt-[480px]">
    ...
    Accredited for <br/> Precision and Reliability
    </h1>
