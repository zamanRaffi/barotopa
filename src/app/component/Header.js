    ...
    <div className="bg-[rgba(29,29,29,0.5)] text-white w-full">
      <header className="p-6 flex justify-between items-center">
        ...
        <nav className="sm:hidden lg:flex space-x-8 items-center">
          ...
          <Link href="/Services" className="hover:text-[#797979]">
            Services
          </Link>
          <Link href="/Resources" className="hover:text-[#797979]">
            Resources
          </Link>
          <Link href="/Infrastructure" className="hover:text-[#797979]">
            Infrastructure
          </Link>
          <Link href="/Accreditation" className="hover:text-[#797979]">
            Accreditation
          </Link>
          <Link
            href="/ContactUs"
