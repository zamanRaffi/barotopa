...
const LogisticsAndTransportationService = () => {
    return (
        <div className="text-white py-12">
            <h2 className="text-4xl font-bold mb-6 px-4 md:text-center md:text-5xl md:mb-16">Logistics & Transportation <br className='md:hidden'/> Service</h2>
...
<img src='/Transportation_1ForLs.png'
className='w-[884px]'
/>
<h2 className=' text-2xl mt-8 px-4'>Automatic Book Binding Machine</h2>
</div>


{/* 2nd Card */}
<div className='w-1/2 px-10 mb-12'>
<img src='/Transportation_2.png'
className='w-[884px]'
/>
<h2 className=' text-2xl mt-8 px-4'>Web Printing Machine single color</h2>
</div>
</div>
