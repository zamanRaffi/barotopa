...
const Hero = () => {
  return (
    <section className="text-white mb-3 flex flex-col md:mb-14">
      ...
      <div className="relative px-4 bg-cover flex flex-col bg-[url('/HeroForServiceForSm.png')] md:bg-[url('/HeroForResources.png')]">
        {/* Gradient Overlay */}
        ...
        <div className="mt-[640px] mb-4 z-10 md:px-14 md:mt-[500px]">
          <h1 className="text-3xl font-extrabold md:text-7xl md:w-1/2 md:leading-tight">
            The Resources <br /> Behind Our Success
          </h1>
          <p className="text-2xl text-[#bfbfbf] mt-7 md:w-4/12 md:text-2xl">
