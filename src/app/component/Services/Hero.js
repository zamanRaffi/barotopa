...
const Hero = () => {
  return (
    <section className="text-white mb-20 flex flex-col lg:mb-14">
      ...
      <div className="relative px-4 bg-cover flex flex-col bg-[url('/HeroForServiceForSm.png')] lg:bg-[url('/HeroForService.png')]">
        {/* Gradient Overlay */}
        ...
        <div className="mt-[640px] mb-4 z-10 lg:px-14 lg:mt-[500px]">
          <h1 className="text-4xl w-10/12 font-extrabold md:text-5xl md:w-2/3 md:leading-tight lg:text-7xl lg:w-1/3 lg:leading-tight">
