...
const teamMembers = [
    { name: "Automatic Book Binding Machine", imgSrc: "/GraphicsConsultancy.png" },
    { name: "Automatic Book Binding Machine", imgSrc: "/HowToCreateYourOwnCustomPrintedBoxesToDisplayYourProducts_.png" },
    { name: "Automatic Book Binding Machine", imgSrc: "/GraphicsConsultancy.png" },
    { name: "Automatic Book Binding Machine", imgSrc: "/HowToCreateYourOwnCustomPrintedBoxesToDisplayYourProducts_.png" },
    { name: "Automatic Book Binding Machine", imgSrc: "/GraphicsConsultancy.png" },
    { name: "Automatic Book Binding Machine", imgSrc: "/HowToCreateYourOwnCustomPrintedBoxesToDisplayYourProducts_.png" },
...
const GraphicsDesignConsultancy = () => {
    return (
        <div className="text-white py-12">
            <h2 className="text-4xl font-bold mb-6 px-4 md:text-center md:text-5xl md:mb-16">Graphics Design Consultancy</h2>
...
<div className='w-1/2 mb-4 px-10 mb-12'>
    <img src='/GraphicsConsultancy.png'
      className='w-[860px]'
    />
  
    <h2 className=' text-3xl mt-8 px-4'>Printing and typesetting industry.</h2>
...
<div className='w-1/2 px-10 mb-12'>
    <img src='/HowToCreateYourOwnCustomPrintedBoxesToDisplayYourProducts_.png'
         className='w-[860px]'
    />
     <h2 className=' text-3xl mt-8 px-4'>Printing and typesetting industry.</h2>
    <div className='flex justify-between items-center px-4'>
